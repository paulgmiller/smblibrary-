...
namespace SMBLibrary
{
    ...
    public class AuthenticationTests
    {
        ...
        {
            byte[] hash = NTAuthentication.NTOWFv1("Password");
        ...
        public static bool LMv1ResponseTest()
        {
            ...
            byte[] response = NTAuthentication.ComputeLMv1Response(challenge, "Password");
        ...
        public static bool LMv2ResponseTest()
        {
            ...
            byte[] response = NTAuthentication.ComputeLMv2Response(serverChallenge, clientChallenge, "Password", "User", "Domain");
