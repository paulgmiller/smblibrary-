...
namespace SMBLibrary.Server
{
    public class StateObject
    {
        ...
        {
            return AddOpenedFile(relativePath, false);
        }

        public ushort AddOpenedFile(string relativePath, bool isSequentialAccess)
        {
            ushort fileID = AllocateFileID();
            m_openedFiles.Add(fileID, new OpenedFileObject(relativePath, isSequentialAccess));
            return fileID;
        }
